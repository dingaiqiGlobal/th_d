...
export default {
  ...
  methods: {
        ...
        .add(
          {
            fn: () => {
              // 创建一个相机动画
              this.createGsapAnimation(this.camera.position, { x: 20, y: 20, z: 20 });
              // 创建一个目标运动动画
             this.createGsapAnimation(this.controls.target, { x: -5, y: 2, z: 1 });
            },
          },
          "fn"
        )
    ...
    createGsapAnimation(position, position_, gsapQuery = null) {
      //设置动画 x轴运动 持续时间
