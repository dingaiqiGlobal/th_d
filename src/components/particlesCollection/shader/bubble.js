...
`;
  ...
  constructor(config) {
    ...
    this.uniforms.maxHeight.value =
      config.maxHeight || this.uniforms.maxHeight.value;
  ...
  setPoints = () => {
    ...
    this.geometry.setAttribute(
      "data1",
      new Float32BufferAttribute(data1Array, 1)
    );
    this.geometry.setAttribute(
      "data2",
      new Float32BufferAttribute(data2Array, 1)
    );
  };
